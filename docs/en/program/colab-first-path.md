...
- One paper maps to one note and one Colab notebook.
- Every reproduction leaves behind at least a reading note, an experiment log, and a short memo.
...
- Colab-first does not mean toy-only.
